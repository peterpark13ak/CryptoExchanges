...
const EthBox = styled.div<EthBoxProps>`
    ...
    &:focus-within {
        border-color: ${props =>
            props.boxType === ETHBoxType.Wmatic
            ...
            <Modal {...restProps}>
                ...
                <EthBoxes>
                    <EthBox boxType={ETHBoxType.Eth}>
                        ...
                        <EthBoxUnit>MATIC</EthBoxUnit>
                    </EthBox>
                    <EthBox boxType={ETHBoxType.Wmatic}>
                        {editing === Editing.Wmatic ? (
                            <FormBox noValidate={true} onSubmit={this._disableEdit}>
                                <InputEth
                                    autofocus={true}
                        ...
                        <EthBoxUnit>wMATIC</EthBoxUnit>
                        <TooltipStyled>
                            <Tooltip description="MATIC cannot be traded with other tokens directly.<br />You need to convert it to WMATIC first.<br />WMATIC can be converted back to MATIC at any time." />
                        </TooltipStyled>
                    </EthBox>
                </EthBoxes>
                <Slider
                ...
                <SetMinEthWrapper hideWarning={isInsufficientEth ? false : true}>
                    MATIC required for fees.&nbsp;
                    <SetMinEthButton href="" onClick={this._setMinEth}>
                        0.05 MATIC Recommended
                    </SetMinEthButton>
                </SetMinEthWrapper>
