...
class WalletWethBalance extends React.PureComponent<Props, State> {
    ...
    public render = () => {
                ...
                <>
                    ...
                    <Row>
                        <LabelWrapper>
                            <Label>wMATIC</Label>{' '}
                            <Tooltip
                                description="MATIC cannot be traded with other tokens directly.<br />You need to convert it to WMATIC first.<br />WMATIC can be converted back to MATIC at any time."
                    ...
                    <Row>
                        ...
                        <Value>{formattedTotalEth} MATIC</Value>
                    </Row>
                    <WethModal
                        ethInUsd={ethInUsd}
        ...
        return (
            <>
                <Card title={inDropdown ? '' : 'MATIC / wMATIC Balances'} className={className}>
                    <Content>{content}</Content>
                </Card>
                {inDropdown ? null : (
                    <Note>
                        wMATIC is used for trades on 0x
                        <br />1 wMATIC = 1 MATIC
                    </Note>
                )}
            </>
